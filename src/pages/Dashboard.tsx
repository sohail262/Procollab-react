...
export function Dashboard() {
    ...
    useEffect(() => {
        ...
        const loadData = async () => {
            setLoading(true);
            try {
                const [statsData, activityData, recommendedData, projectsData, appsData] = await Promise.all([
                ...
                setRecommendedProjects(recommendedData);
                setMyProjects(projectsData.slice(0, 5));
